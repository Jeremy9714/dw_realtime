...
/**
 * @Description:
 * @Author: Chenyang on 2024/11/29 12:46
 * @Version: 1.0
 */
public class JdbcUtils {
    ...
    public static Connection getMysqlConnection() throws ClassNotFoundException, SQLException {
        // 获取 jdbc 连接
        // 1. 加载驱动
        Class.forName(DwConstant.MYSQL_DRIVER);
        return DriverManager.getConnection(DwConstant.MYSQL_URL, DwConstant.MYSQL_USER_NAME, DwConstant.MYSQL_PASSWORD);
    }
